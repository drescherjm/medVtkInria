...
Program:   vtkINRIA3D
Module:    $Id: TestSynchronizedViews.cxx 477 2007-11-20 17:46:10Z filus $
Language:  C++
Author:    $Author: filus $
...
int vtkImageViewTest4(int argc, char* argv[])
{
  int res = 0;
...
//   view1->SetLeftButtonInteractionStyle   (vtkImageView2D::ZOOM_INTERACTION);
//   view1->SetMiddleButtonInteractionStyle (vtkImageView2D::SELECT_INTERACTION);
//   view1->SetWheelInteractionStyle        (vtkImageView2D::SELECT_INTERACTION);
//   view1->SetRightButtonInteractionStyle  (vtkImageView2D::WINDOW_LEVEL_INTERACTION);
// 
//   view2->SetLeftButtonInteractionStyle   (vtkImageView2D::ZOOM_INTERACTION);
//   view2->SetMiddleButtonInteractionStyle (vtkImageView2D::SELECT_INTERACTION);
//   view2->SetWheelInteractionStyle        (vtkImageView2D::SELECT_INTERACTION);
//   view2->SetRightButtonInteractionStyle  (vtkImageView2D::WINDOW_LEVEL_INTERACTION);
// 
//   view3->SetLeftButtonInteractionStyle   (vtkImageView2D::ZOOM_INTERACTION);
//   view3->SetMiddleButtonInteractionStyle (vtkImageView2D::SELECT_INTERACTION);
//   view3->SetWheelInteractionStyle        (vtkImageView2D::SELECT_INTERACTION);
//   view3->SetRightButtonInteractionStyle  (vtkImageView2D::WINDOW_LEVEL_INTERACTION);
...
//   view4->SetLinkZoom (true);
  ...
  view1->SetViewOrientation (vtkImageView2D::VIEW_ORIENTATION_AXIAL);
  view2->SetViewOrientation (vtkImageView2D::VIEW_ORIENTATION_CORONAL);
  view3->SetViewOrientation (vtkImageView2D::VIEW_ORIENTATION_SAGITTAL);
