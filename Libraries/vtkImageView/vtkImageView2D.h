...
public:
   ...
   **/
    ...
    enum
    {
		VIEW_CONVENTION_NEUROLOGICAL                 = 0,
		VIEW_CONVENTION_RADIOLOGICAL_LUNG            = 1,
		VIEW_CONVENTION_RADIOLOGICAL                 = VIEW_CONVENTION_RADIOLOGICAL_LUNG,
		VIEW_CONVENTION_RADIOLOGICAL_BREAST          = 2,
		VIEW_CONVENTION_LUNG_HFS_AXIAL_VIEW_AXIAL    = 3,
		VIEW_CONVENTION_LUNG_HFS_AXIAL_VIEW_CORONAL  = 4,
