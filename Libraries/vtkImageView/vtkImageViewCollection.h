...
Program:   vtkINRIA3D
Module:    $Id: vtkImageViewCollection.h 833 2008-05-15 12:17:31Z ntoussaint $
Language:  C++
...
#define vtkSyncSetMacro(name, type)					\
  virtual void SyncSet##name (type _arg, vtkImageView* caller=0)	\
  {									\
    this->InitTraversal();						\
...
class MEDVTKINRIA_EXPORT vtkImageViewCollection : public vtkCollection
{
 ...
 public:
  ...
  vtkSyncSetObjectMacro (Input, vtkAlgorithmOutput);
  ...
  virtual void SyncRender (vtkImageView* caller = NULL);
