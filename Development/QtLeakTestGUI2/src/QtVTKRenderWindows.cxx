...
void QtVTKRenderWindows::setupImage()
{
	...
	m_pImage = createTestImage(320, 320, 64);
...
// 		[this]() {
// 			m_pImage = createTestImage(1024, 768, 64);
// 
// 			vtkNew<vtkImageReslice> reslice;
// 
// 			reslice->SetInputData(m_pImage);
// 			reslice->Update();
// 
// 			riw->SetInputConnection(reslice->GetOutputPort());
// 		}
// 	);
...
void QtVTKRenderWindows::setupSignalsAndSlots()
{
