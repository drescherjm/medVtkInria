...
ReferenceCountModel::ReferenceCountModel(QObject* p)
  : QStandardItemModel(0, 3, p)
{
  this->setHeaderData(0, Qt::Horizontal, QObject::tr("Pointer"));
  this->setHeaderData(1, Qt::Horizontal, QObject::tr("Allocation Timestamp"));
  this->setHeaderData(2, Qt::Horizontal, QObject::tr("Reference Count"));
...
void ReferenceCountModel::addObject(vtkObjectBase* obj)
{
  ...
  this->setData(this->index(row, 1), QDateTime::currentDateTime().toString(Qt::ISODateWithMs));
  this->setData(this->index(row, 2), obj->GetReferenceCount());
}
