...
# Only add extra flags on Linux builds
if(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    set(EXTRA_C_FLAGS "-fcommon -Wno-old-style-definition")
    set(EXTRA_CXX_FLAGS "-fcommon -Wno-old-style-definition")
else()
    set(EXTRA_C_FLAGS "")
    set(EXTRA_CXX_FLAGS "")
endif()
